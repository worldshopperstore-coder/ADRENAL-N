...
type KasaCardProps = { kasa: typeof KASAS[number] };
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 mt-8">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Her kasa için haftalık satış hedefi belirleyin (TL) — personeller sadece bar yüzdesini görür</p>
        </div>
      </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 text-xs text-gray-500 space-y-1">
        ...
        <p>• Hedefe ulaşıldığında satış panelinde tebrikler mesajı gösterilir.</p>
      </div>
    </div>
  );
}
