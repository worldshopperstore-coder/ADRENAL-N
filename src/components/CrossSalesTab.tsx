...
// ── Standalone exported fonksiyon — SalesPanel'den de çağrılabilir ──
function detectVenues(packageName: string): string[] {
...
function getCrossTotals(crossSales: CrossSale[]) {
  return {
...
export default function CrossSalesTab() {
  ...
  // Artık dışarıdaki exported generateCrossHTMLReport kullanılıyor
